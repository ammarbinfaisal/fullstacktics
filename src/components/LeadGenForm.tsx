...
export default function LeadGenForm() {
  ...
  return (
    <section className="py-12 md:py-24 mx-auto relative">
      {/* Background gradient */}
      <div className="absolute inset-0 bg-yellow-400/5 rounded-3xl"></div>
      
      <div className="relative z-10">
        <div className="flex flex-col items-center gap-4 text-center">
          <h2 className="text-2xl font-bold tracking-tighter sm:text-3xl md:text-4xl lg:text-5xl">
            Let&apos;s discuss your <span className="text-yellow-400">project</span>
          </h2>
          ...
          <div className="flex flex-col items-center gap-4 text-center">
            <Cal>
              <Button className="group bg-yellow-400 hover:bg-yellow-300 text-black font-semibold">
