...
const ServicePageTemplate = ({ serviceData }: { serviceData: ServiceData }) => {
	...
	const getTechTabs = () => {
		return Object.entries(serviceData.technicalDetails).map(
			([key, value]) => {
				// Handle nested objects in technical details
				if (typeof value === "object" && !Array.isArray(value)) {
					const nestedItems = Object.entries(value).flatMap(
			...
			<div className='min-h-screen'>
				<div className='max-w-7xl mx-auto px-4 lg:px-6 lg:px-8 py-12 md:py-24'>
					...
					<Card className='mb-8'>
						...
						<CardContent>
							<ul className='space-y-4'>
								{serviceData.testimonials.comments.map(
									(comment, index) => (
										<li
											key={index}
					...
					<Card className='mb-8'>
						...
						<CardContent>
							<Tabs
								defaultValue={getTechTabs()[0].value}
					...
					<Card>
						<CardHeader>
							...
							<CardDescription className='text-center'>
								...
								{serviceData.title.toLowerCase()} solutions can
								enhance your technical infrastructure
							</CardDescription>
						</CardHeader>
