	...
	return (
		<html lang='en'>
			<head>
				...
				<meta
					property='og:url'
					content='https://fullstacktics.com'
				></meta>
				<meta
					property='og:title'
					content='Fullstacktics - Software Development Agency'
				...
				<link
					rel='stylesheet'
					href='https://cdn.jsdelivr.net/gh/orestbida/cookieconsent@/dist/cookieconsent.css'
				/>
...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
    ...
    (function(c,l,a,r,i,t,y){
        ...
        `,
			...
			<body
				className={`${jetBrainsMono.className} antialiased w-full dark`}
			>
				<noscript>
					<iframe
						src='https://www.googletagmanager.com/ns.html?id=GTM-NMQS73V7'
						height='0'
						width='0'
						style={{
							display: "none",
